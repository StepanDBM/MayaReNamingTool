...
class RenameTab(QtWidgets.QWidget):
    ...
    def toggle_quick_suffix_case(self):
        self.quick_suffix_uppercase = not self.quick_suffix_uppercase
    ...
    def build_ui(self):
        ...
        self.add_section("------------------ Strip Namespaces ------------------")
        ...
        self.add_section("---------------- Rename and Number ----------------")
        ...
        self.add_section("------------------ Renumber Existing ------------------")

        renumber_layout = QtWidgets.QHBoxLayout()

        self.renumber_offset_spin = QtWidgets.QSpinBox()
        self.renumber_offset_spin.setRange(-9999, 9999)
        self.renumber_offset_spin.setValue(1)

        self.renumber_minus_btn = QtWidgets.QPushButton("-1")
        self.renumber_plus_btn = QtWidgets.QPushButton("+1")
        self.renumber_apply_btn = QtWidgets.QPushButton("Apply Offset")

        renumber_layout.addWidget(QtWidgets.QLabel("Offset:"))
        renumber_layout.addWidget(self.renumber_offset_spin)
        renumber_layout.addWidget(self.renumber_minus_btn)
        renumber_layout.addWidget(self.renumber_plus_btn)
        renumber_layout.addWidget(self.renumber_apply_btn)

        main_layout.addLayout(renumber_layout)

        # -------------------------
        # Remove Characters
        # -------------------------

        self.add_section("--------------- Add/Remove Characters ---------------")
        ...
        quick_grid.addWidget(self.quick_suffix_case_btn, 0, 0, 2, 1)
    ...
    def create_connections(self):
        ...
        self.renumber_minus_btn.clicked.connect(
            lambda:
            rename.renumber_underscore_selection(
                -1
            )
        )

        self.renumber_plus_btn.clicked.connect(
            lambda:
            rename.renumber_underscore_selection(
                1
            )
        ...
        self.renumber_apply_btn.clicked.connect(
            lambda:
            rename.renumber_underscore_selection(
                self.renumber_offset_spin.value()
            )
        )
